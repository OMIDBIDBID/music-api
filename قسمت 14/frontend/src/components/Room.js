...
export default class Room extends Component {
  ...
  componentDidMount() {
    this.iterval = setInterval(this.getCurrentSong, 1000);
  }
  ...
  renderSettingsButton() {
    return (
      <Grid item xs={12} align="center">
        <Button variant="contained" color="primary" onClick={() => this.updateShowSettings(true)}>تنظیمات</Button>
      </Grid>
    )
  }
  ...
  renderSettings() {
    return (
      <Grid container spacing={1}>
        ...
        <Grid item xs={12} align="center">
          <Button variant="contained" color="secondary" onClick={() => this.updateShowSettings(false)}>بازگشت</Button>
        </Grid>
      </Grid>
      )
  }
